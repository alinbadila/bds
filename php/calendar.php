...
<body>
      ...
      <div class="row">
        <div class="col-lg-12 text-center">
          <p> Alege altă dată: <input type="text" id="datepicker" maxlength="20" size="25" readonly>
              ...
              <input class="btn btn-primary btn-sm" id="butonOkData" type="submit" value="ok2" onclick="location.href='calendar.php' + '?dataAleasa=' + document.getElementById('rezdatepicker').value;">
  ...
  <script>
    function arataData() {
      document.getElementById('rezdatepicker').value = document.getElementById('datepicker').value;
    }
  </script>
